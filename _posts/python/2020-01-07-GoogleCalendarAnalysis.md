...
An effort to maximize productivity and track the progress.  
...
This is what my calendar looked like in the first week.

<img src="/images/g-calendar/g-calendar.png" alt="Calendar image"/>
...
<img src="/images/g-calendar/g-csv.png" alt="csv image"/>
...
The source code for this project is in python. Source code can be found <!---<a href="/source_code/google-calendar.py">here</a>-->
[here](https://github.com/akhilayaragoppa/akhilayaragoppa.github.io/blob/master/source_code/google-calendar.py).
